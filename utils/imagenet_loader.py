...
class ImageNet(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None, img_size=64):
        ...
        for idx in range(1, 11):
            # CSL [/nobackup-slow/dataset/ImageNet/] | Local [datasets/ood_datasets/ImageNet/]
            data_file = os.path.join('../GradNorm_OE/datasets/ood_datasets/ImageNet/', 'train_data_batch_{}'.format(idx))
    ...
    def load_image_batch(self, batch_index):
        # CSL [/nobackup-slow/dataset/ImageNet/] | Local [datasets/ood_datasets/ImageNet/]
        data_file = os.path.join('../GradNorm_OE/datasets/ood_datasets/ImageNet/', 'train_data_batch_{}'.format(batch_index))
        d = unpickle(data_file)
        x = d['data']
