...
class TinyImages(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None, exclude_cifar=True):
        # CSL [/nobackup-slow/dataset/80million/tiny_images.bin] | Local [datasets/unlabeled_datasets/80M_Tiny_Images/tiny_images.bin]
        ...
        if exclude_cifar:
            ...
            # CSL [/nobackup-slow/dataset/80million/80mn_cifar_idxs.txt] | Local [datasets/unlabeled_datasets/80M_Tiny_Images/80mn_cifar_idxs.txt]
